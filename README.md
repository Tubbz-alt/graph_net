...
[Graph Nets](https://github.com/deepmind/graph_network) is DeepMind's library for
...
```shell
$ pip install graph_network tensorflow tensorflow_probability
```

To install the Graph Nets library for GPU, run:

```shell
$ pip install graph_network tensorflow_gpu tensorflow_probability_gpu
```
...
#### [Run "shortest path demo" in browser](https://colab.research.google.com/github/deepmind/graph_network/blob/master/graph_network/demos/shortest_path.ipynb)
...
#### [Run "sort demo" in browser](https://colab.research.google.com/github/deepmind/graph_network/blob/master/graph_network/demos/sort.ipynb)
...
#### [Run "physics demo" in browser](https://colab.research.google.com/github/deepmind/graph_network/blob/master/graph_network/demos/physics.ipynb)
