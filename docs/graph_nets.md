...
### [`class blocks.EdgeBlock`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:EdgeBlock)<!-- blocks.EdgeBlock .code-reference -->
...
#### [`blocks.EdgeBlock.__init__(edge_model_fn, use_edges=True, use_receiver_nodes=True, use_sender_nodes=True, use_globals=True, name='edge_block')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=374)<!-- blocks.EdgeBlock.__init__ .code-reference -->
...
#### [`blocks.EdgeBlock.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=418)<!-- blocks.EdgeBlock.__call__ .code-reference -->
...
### [`class blocks.EdgesToGlobalsAggregator`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:EdgesToGlobalsAggregator)<!-- blocks.EdgesToGlobalsAggregator .code-reference -->

Aggregates all edges into globals.

#### [`blocks.EdgesToGlobalsAggregator.__init__(reducer, name='edges_to_globals_aggregator')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=164)<!-- blocks.EdgesToGlobalsAggregator.__init__ .code-reference -->
...
#### [`blocks.EdgesToGlobalsAggregator.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=188)<!-- blocks.EdgesToGlobalsAggregator.__call__ .code-reference -->
...
### [`class blocks.GlobalBlock`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:GlobalBlock)<!-- blocks.GlobalBlock .code-reference -->
...
#### [`blocks.GlobalBlock.__init__(global_model_fn, use_edges=True, use_nodes=True, use_globals=True, nodes_reducer=unsorted_segment_sum, edges_reducer=unsorted_segment_sum, name='global_block')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=579)<!-- blocks.GlobalBlock.__init__ .code-reference -->
...
#### [`blocks.GlobalBlock.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=637)<!-- blocks.GlobalBlock.__call__ .code-reference -->
...
### [`class blocks.NodeBlock`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:NodeBlock)<!-- blocks.NodeBlock .code-reference -->
...
#### [`blocks.NodeBlock.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=536)<!-- blocks.NodeBlock.__call__ .code-reference -->
...
### [`class blocks.NodesToGlobalsAggregator`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:NodesToGlobalsAggregator)<!-- blocks.NodesToGlobalsAggregator .code-reference -->

Aggregates all nodes into globals.

#### [`blocks.NodesToGlobalsAggregator.__init__(reducer, name='nodes_to_globals_aggregator')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=200)<!-- blocks.NodesToGlobalsAggregator.__init__ .code-reference -->
...
#### [`blocks.NodesToGlobalsAggregator.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=224)<!-- blocks.NodesToGlobalsAggregator.__call__ .code-reference -->
...
### [`class blocks.ReceivedEdgesToNodesAggregator`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:ReceivedEdgesToNodesAggregator)<!-- blocks.ReceivedEdgesToNodesAggregator .code-reference -->

Agregates received edges into the corresponding receiver nodes.

#### [`blocks.ReceivedEdgesToNodesAggregator.__init__(reducer, name='received_edges_to_nodes_aggregator')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=283)<!-- blocks.ReceivedEdgesToNodesAggregator.__init__ .code-reference -->
...
#### [`blocks.ReceivedEdgesToNodesAggregator.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=242)<!-- blocks.ReceivedEdgesToNodesAggregator.__call__ .code-reference -->
...
### [`class blocks.SentEdgesToNodesAggregator`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?q=class:SentEdgesToNodesAggregator)<!-- blocks.SentEdgesToNodesAggregator .code-reference -->

Agregates sent edges into the corresponding sender nodes.

#### [`blocks.SentEdgesToNodesAggregator.__init__(reducer, name='sent_edges_to_nodes_aggregator')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=253)<!-- blocks.SentEdgesToNodesAggregator.__init__ .code-reference -->
...
#### [`blocks.SentEdgesToNodesAggregator.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=242)<!-- blocks.SentEdgesToNodesAggregator.__call__ .code-reference -->
...
### [`blocks.broadcast_globals_to_edges(graph, name='broadcast_globals_to_edges')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=68)<!-- blocks.broadcast_globals_to_edges .code-reference -->
...
### [`blocks.broadcast_globals_to_nodes(graph, name='broadcast_globals_to_nodes')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=92)<!-- blocks.broadcast_globals_to_nodes .code-reference -->
...
### [`blocks.broadcast_receiver_nodes_to_edges(graph, name='broadcast_receiver_nodes_to_edges')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=139)<!-- blocks.broadcast_receiver_nodes_to_edges .code-reference -->
...
### [`blocks.broadcast_sender_nodes_to_edges(graph, name='broadcast_sender_nodes_to_edges')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=116)<!-- blocks.broadcast_sender_nodes_to_edges .code-reference -->
...
### [`blocks.unsorted_segment_max_or_zero(values, indices, num_groups, name='unsorted_segment_max_or_zero')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=342)<!-- blocks.unsorted_segment_max_or_zero .code-reference -->
...
### [`blocks.unsorted_segment_min_or_zero(values, indices, num_groups, name='unsorted_segment_min_or_zero')`](https://github.com/deepmind/graph_network/blob/master/graph_network/blocks.py?l=320)<!-- blocks.unsorted_segment_min_or_zero .code-reference -->
...
### [`class graphs.GraphsTuple`](https://github.com/deepmind/graph_network/blob/master/graph_network/graphs.py?q=class:GraphsTuple)<!-- graphs.GraphsTuple .code-reference -->
...
#### [`graphs.GraphsTuple.__init__(*args, **kwargs)`](https://github.com/deepmind/graph_network/blob/master/graph_network/graphs.py?l=153)<!-- graphs.GraphsTuple.__init__ .code-reference -->
...
#### [`graphs.GraphsTuple.map(field_fn, fields=('nodes', 'edges', 'globals'))`](https://github.com/deepmind/graph_network/blob/master/graph_network/graphs.py?l=165)<!-- graphs.GraphsTuple.map .code-reference -->
...
#### [`graphs.GraphsTuple.replace(**kwargs)`](https://github.com/deepmind/graph_network/blob/master/graph_network/graphs.py?l=160)<!-- graphs.GraphsTuple.replace .code-reference -->
...
### [`class modules.CommNet`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:CommNet)<!-- modules.CommNet .code-reference -->
...
#### [`modules.CommNet.__init__(edge_model_fn, node_encoder_model_fn, node_model_fn, reducer=unsorted_segment_sum, name='comm_net')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=470)<!-- modules.CommNet.__init__ .code-reference -->
...
#### [`modules.CommNet.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=521)<!-- modules.CommNet.__call__ .code-reference -->
...
### [`class modules.DeepSets`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:DeepSets)<!-- modules.DeepSets .code-reference -->
...
#### [`modules.DeepSets.__init__(node_model_fn, global_model_fn, reducer=unsorted_segment_sum, name='deep_sets')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=401)<!-- modules.DeepSets.__init__ .code-reference -->
...
#### [`modules.DeepSets.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=436)<!-- modules.DeepSets.__call__ .code-reference -->
...
### [`class modules.GraphIndependent`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:GraphIndependent)<!-- modules.GraphIndependent .code-reference -->
...
#### [`modules.GraphIndependent.__init__(edge_model_fn=None, node_model_fn=None, global_model_fn=None, name='graph_independent')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=314)<!-- modules.GraphIndependent.__init__ .code-reference -->
...
#### [`modules.GraphIndependent.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=356)<!-- modules.GraphIndependent.__call__ .code-reference -->
...
### [`class modules.GraphNetwork`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:GraphNetwork)<!-- modules.GraphNetwork .code-reference -->

Implementation of a Graph Network.

See https://arxiv.org/abs/1806.01261 for more details.

#### [`modules.GraphNetwork.__init__(edge_model_fn, node_model_fn, global_model_fn, reducer=unsorted_segment_sum, edge_block_opt=None, node_block_opt=None, global_block_opt=None, name='graph_network')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=240)<!-- modules.GraphNetwork.__init__ .code-reference -->
...
#### [`modules.GraphNetwork.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=289)<!-- modules.GraphNetwork.__call__ .code-reference -->
...
### [`class modules.InteractionNetwork`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:InteractionNetwork)<!-- modules.InteractionNetwork .code-reference -->
...
#### [`modules.InteractionNetwork.__init__(edge_model_fn, node_model_fn, reducer=unsorted_segment_sum, name='interaction_network')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=93)<!-- modules.InteractionNetwork.__init__ .code-reference -->
...
#### [`modules.InteractionNetwork.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=124)<!-- modules.InteractionNetwork.__call__ .code-reference -->
...
### [`class modules.RelationNetwork`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:RelationNetwork)<!-- modules.RelationNetwork .code-reference -->
...
#### [`modules.RelationNetwork.__init__(edge_model_fn, global_model_fn, reducer=unsorted_segment_sum, name='relation_network')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=153)<!-- modules.RelationNetwork.__init__ .code-reference -->
...
#### [`modules.RelationNetwork.__call__(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=188)<!-- modules.RelationNetwork.__call__ .code-reference -->
...
### [`class modules.SelfAttention`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?q=class:SelfAttention)<!-- modules.SelfAttention .code-reference -->
...
#### [`modules.SelfAttention.__init__(name='self_attention')`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=620)<!-- modules.SelfAttention.__init__ .code-reference -->
...
#### [`modules.SelfAttention.__call__(node_values, node_keys, node_queries, attention_graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/modules.py?l=629)<!-- modules.SelfAttention.__call__ .code-reference -->
...
### [`utils_np.data_dict_to_networkx(data_dict)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=227)<!-- utils_np.data_dict_to_networkx .code-reference -->
...
### [`utils_np.data_dicts_to_graphs_tuple(data_dicts)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=357)<!-- utils_np.data_dicts_to_graphs_tuple .code-reference -->
...
### [`utils_np.get_graph(input_graphs, index)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=518)<!-- utils_np.get_graph .code-reference -->
...
### [`utils_np.graphs_tuple_to_data_dicts(graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=384)<!-- utils_np.graphs_tuple_to_data_dicts .code-reference -->
...
### [`utils_np.graphs_tuple_to_networkxs(graphs_tuple)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=343)<!-- utils_np.graphs_tuple_to_networkxs .code-reference -->
...
### [`utils_np.networkx_to_data_dict(graph_nx, node_shape_hint=None, edge_shape_hint=None, data_type_hint=float32)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=108)<!-- utils_np.networkx_to_data_dict .code-reference -->
...
### [`utils_np.networkxs_to_graphs_tuple(graph_nxs, node_shape_hint=None, edge_shape_hint=None, data_type_hint=float32)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_np.py?l=289)<!-- utils_np.networkxs_to_graphs_tuple .code-reference -->
...
### [`utils_tf.concat(input_graphs, axis, name='graph_concat')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=350)<!-- utils_tf.concat .code-reference -->
...
### [`utils_tf.data_dicts_to_graphs_tuple(data_dicts, name='data_dicts_to_graphs_tuple')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=924)<!-- utils_tf.data_dicts_to_graphs_tuple .code-reference -->
...
### [`utils_tf.fully_connect_graph_dynamic(graph, exclude_self_edges=False, name='fully_connect_graph_dynamic')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=768)<!-- utils_tf.fully_connect_graph_dynamic .code-reference -->
...
### [`utils_tf.fully_connect_graph_static(graph, exclude_self_edges=False, name='fully_connect_graph_static')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=700)<!-- utils_tf.fully_connect_graph_static .code-reference -->
...
### [`utils_tf.get_feed_dict(placeholders, graph)`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=217)<!-- utils_tf.get_feed_dict .code-reference -->
...
### [`utils_tf.get_graph(input_graphs, index, name='get_graph')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=955)<!-- utils_tf.get_graph .code-reference -->
...
### [`utils_tf.get_num_graphs(input_graphs, name='get_num_graphs')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=1023)<!-- utils_tf.get_num_graphs .code-reference -->
...
### [`utils_tf.identity(graph, name='graph_identity')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=463)<!-- utils_tf.identity .code-reference -->
...
### [`utils_tf.make_runnable_in_session(graph, name='make_graph_runnable_in_session')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=488)<!-- utils_tf.make_runnable_in_session .code-reference -->
...
### [`utils_tf.placeholders_from_data_dicts(data_dicts, force_dynamic_num_graphs=False, name='placeholders_from_data_dicts')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=261)<!-- utils_tf.placeholders_from_data_dicts .code-reference -->
...
### [`utils_tf.placeholders_from_networkxs(graph_nxs, node_shape_hint=None, edge_shape_hint=None, data_type_hint=tf.float32, force_dynamic_num_graphs=True, name='placeholders_from_networkxs')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=282)<!-- utils_tf.placeholders_from_networkxs .code-reference -->
...
### [`utils_tf.repeat(tensor, repeats, axis=0, name='repeat')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=510)<!-- utils_tf.repeat .code-reference -->
...
### [`utils_tf.set_zero_edge_features(graph, edge_size, dtype=tf.float32, name='set_zero_edge_features')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=857)<!-- utils_tf.set_zero_edge_features .code-reference -->
...
### [`utils_tf.set_zero_global_features(graph, global_size, dtype=tf.float32, name='set_zero_global_features')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=893)<!-- utils_tf.set_zero_global_features .code-reference -->
...
### [`utils_tf.set_zero_node_features(graph, node_size, dtype=tf.float32, name='set_zero_node_features')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=825)<!-- utils_tf.set_zero_node_features .code-reference -->
...
### [`utils_tf.stop_gradient(graph, stop_edges=True, stop_nodes=True, stop_globals=True, name='graph_stop_gradient')`](https://github.com/deepmind/graph_network/blob/master/graph_network/utils_tf.py?l=418)<!-- utils_tf.stop_gradient .code-reference -->
